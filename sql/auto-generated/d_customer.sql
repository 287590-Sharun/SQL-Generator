...
----------------------------------------------------------------------
0.0         2026-06-21    auto-generated from mapping         ai_agent
**********************************************************************/
...
left join 
    cm_mstr cm 
    on upper(cm.cm_addr) = upper(ad.ad_addr) 
    and upper(cm.cm_domain) = upper(ad.ad_domain)
left join 
    currency cur 
    on cur.currencycode = cm.cm_curr
inner join 
    d_cntry_hier cntry 
    on upper(ad.ad_ctry) = upper(cntry.cntry_alpha2_cd)
;