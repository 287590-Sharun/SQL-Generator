...
----------------------------------------------------------------------
0.0         2026-06-22    auto-generated from mapping         ai_agent
**********************************************************************/
...
from 
    po_dedup po
left join cm_mstr cm on po.some_key = cm.some_key
left join ad_mstr ad on lower(ad.ad_domain) = lower(cm.cm_domain) and ad.ad_addr = cm.cm_addr
;