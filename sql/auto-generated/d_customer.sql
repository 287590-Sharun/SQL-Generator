...
from 
    ad_mstr ad
left join 
    cm_mstr cm on upper(cm.cm_addr) = upper(ad.ad_addr) and upper(cm.cm_domain) = upper(ad.ad_domain)
left join 
    currency curr on curr.currencycode = cm.cm_curr
inner join 
    d_cntry_hier dch on upper(ad.ad_ctry) = upper(dch.cntry_alpha2_cd)
;