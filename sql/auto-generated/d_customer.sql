...
----------------------------------------------------------------------
0.0         2026-08-12    auto-generated from mapping         ai_agent
**********************************************************************/
...
select 
    ...
    cast(cm_mstr.cm_addr as string) as cust_id,
    ...
    cast(cm_mstr.cm_mod_date as string) as src_updt_ts,
...
from cm_mstr cm_mstr
left join ad_mstr ad_mstr
    on lower(ad_mstr.ad_domain) = lower(cm_mstr.cm_domain) 
    and ad_mstr.ad_addr = cm_mstr.cm_addr
;